      ...
      <div className="relative z-10 container mx-auto px-4 py-12 lg:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
          {data.map((val, index) => (
            ...
            >
              <div className="bg-white bg-opacity-10 backdrop-blur-md rounded-xl p-6 h-full flex flex-col hover:bg-opacity-20 transition-all duration-300 hover:shadow-lg hover:shadow-yellow-400/20 hover:-translate-y-2 border border-white border-opacity-20">
