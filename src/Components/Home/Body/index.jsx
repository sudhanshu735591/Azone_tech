    ...
    return(
      ...
      <div class="grid md:grid-cols-2 items-center md:gap-10 gap-6">
        <div class="max-md:order-1 max-md:text-center">
          ...
          <h2 class="text-gray-800 md:text-5xl text-3xl font-extrabold mb-4 md:!leading-[55px]"> Web Development Services</h2>
          <p class="mt-5 text-base text-gray-500 leading-relaxed">Embark on a digital journey with our expertly crafted web solutions, designed to elevate your online presence. Transform your vision into reality today.</p>
      ...
      <div className="flex gap-20 flex-wrap lg:flex-nowrap justify-center">
      <Card/>
      <Card/>
      <Card/>
      </div>
